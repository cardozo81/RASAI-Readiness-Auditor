...
O modelo hospedado usa workloads Linux/container, PostgreSQL gerenciado, scheduling/fila duráveis e armazenamento de objetos.
...
SQLite é o adapter local. PostgreSQL é o adapter centralizado. Evidência bruta do provider e manifests com hash permanecem fora das linhas relacionais e migram naturalmente para armazenamento de objetos na operação hospedada.
...
## Resultados externos e observabilidade de crawlers
