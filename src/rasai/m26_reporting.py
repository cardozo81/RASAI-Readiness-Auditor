...
def _page(data: dict[str, Any], report_dir: Path) -> str:
    ...
    <section class='panel notice-critical'>
      ...
      <p><strong>Proveniência:</strong> Observed Generative Visibility é import-first. A fonte e o método de captura são declarados no artifact fornecido ao RASAi; o RASAi não faz scraping, não autentica o portal externo nem afirma que realizou coleta direta; a declaração de origem não é convertida em prova de coleta autenticada no sistema externo.</p>
