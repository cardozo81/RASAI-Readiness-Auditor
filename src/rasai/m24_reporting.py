...
<p class='lead'>Diagnóstico aprofundado de robots.txt, sitemaps/feeds, coerência de descoberta e controles de crawlers. As Regras de Avaliação de Prontidão identificadas tecnicamente por BR-GEO-003, BR-GEO-017 e BR-GEO-018 alimentam o Índice de Prontidão Search & IA. Quando a IA técnica é explicitamente habilitada, ela pode apenas corroborar ou rebaixar os mesmos grupos de sitemap/robots por classes evidence-bound convertidas em fatores estáticos; nunca escolhe pesos numéricos.</p>
...
<p class='intro'>Os diagnósticos aprofundados de rastreamento e descoberta permanecem orientativos e não alteram a pontuação. Separadamente, as Regras de Avaliação de Prontidão BR-GEO-003, BR-GEO-017 e BR-GEO-018 já participam do Método de Pontuação de Prontidão e do Índice de Prontidão Search & IA (IDs técnicos SCORE-GEO-004/SARI-001). llms.txt é explicitamente identificado como proposta comunitária.</p>
