...
.table-wrap{overflow:auto;border:1px solid var(--line);border-radius:10px;background:#fff}table{width:100%;border-collapse:collapse;font-size:.83rem}th,td{text-align:left;vertical-align:top;padding:9px 10px;border-bottom:1px solid #edf0f4}th{background:#f8fafc;color:#4b5565;text-transform:uppercase;letter-spacing:.03em;font-size:.69rem}tr:last-child td{border-bottom:0}
...
@media(max-width:900px){.app-nav{position:sticky;top:0;width:auto;inset:auto;display:flex;gap:5px;overflow:auto;padding:8px;z-index:20}.brand,.nav-group{display:none}.app-nav nav{display:flex;min-width:max-content}.app-nav a{background:#253146;margin:0 2px}.app-main{margin:0;width:100%;padding:18px 12px 40px}.outline{top:47px}.kv{grid-template-columns:1fr}.kv dt{border-bottom:0;padding-bottom:2px}.kv dd{padding-top:2px}}
@media print{body{background:#fff}.app-nav,.outline,.action,.rasai-modal{display:none!important}.app-main{margin:0;width:100%;max-width:none;padding:0}.hero,.panel,.card{box-shadow:none;break-inside:avoid}}
"""
