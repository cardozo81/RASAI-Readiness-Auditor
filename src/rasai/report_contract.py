...
REPORT_CONTRACT_VERSION = "REPORT-CONTRACT-001"
...
REPORT_SURFACES: tuple[ReportSurface, ...] = (
    ...
    ReportSurface(
        ...
        outputs=("findings e evidências Mobile",),
    ...
    ReportSurface(
        ...
        outputs=("findings e evidências Desktop",),
        ai_usage="Pode exibir resultados semânticos de IA já persistidos e identificados como tal.",
        score_impact="Somente as regras que fazem parte do contrato SARI/SCORE contribuem; a página HTML não altera score.",
    ),
    ReportSurface(
    ...
    ReportSurface(
        ...
        optional=True,
        inputs=("Lighthouse accessibility artifact persistido",),
        outputs=("diagnóstico automatizado de acessibilidade",),
        required_dependencies=("coleta Web Performance para o artifact atual",),
        ai_usage="Nenhum.",
    ...
    ReportSurface(
        ...
        optional=True,
        inputs=("PageSpeed/Lighthouse", "CrUX quando disponível"),
        outputs=("métricas de laboratório", "Core Web Vitals de campo", "telemetria de coleta"),
    ...
    ReportSurface(
        ...
        optional=True,
        inputs=("população sintética", "perfis Mobile/Desktop/Tablet", "thresholds configurados"),
    ...
    ReportSurface(
        ...
        outputs=("sugestões textuais advisory", "orientação JSON-LD"),
        optional_dependencies=("provider de IA configurado",),
        ai_usage="Quando IA é usada, o output deve identificar provider/modelo e os inputs persistidos que fundamentaram a sugestão.",
    ...
    ReportSurface(
        ...
        label="Uso de IA",
        optional=True,
        inputs=("telemetria de requests de IA", "provider/modelo", "tokens", "custos estimáveis"),
        outputs=("rastreabilidade de uso de IA", "custo estimado", "status por finalidade"),
        ai_usage="É a superfície de telemetria; não cria chamadas adicionais.",
        score_impact="Nenhum impacto no SCORE-GEO-004.",
    ),
    ReportSurface(
        id="ai-visibility",
