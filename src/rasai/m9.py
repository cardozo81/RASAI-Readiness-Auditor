...
def execute_m9(
    *,
    ...
    # and provider-independent. Unknown local evidence reduces Coverage instead of
    # being converted into a website failure.
...
def _reproducibility_check(
    *,
    ...
    return {
        ...
        "structured_data_absence_policy": "NOT_APPLICABLE_WHEN_ABSENT",
    }
