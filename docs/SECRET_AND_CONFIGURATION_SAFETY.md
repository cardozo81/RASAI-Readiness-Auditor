...
## Mascaramento em tempo de execução

A camada central de secret safety fornece classificação e mascaramento para dados estruturados e texto. Ela cobre, entre outros:
