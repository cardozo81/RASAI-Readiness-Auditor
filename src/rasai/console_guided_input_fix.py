...
def install() -> None:
    ...
    # Some legacy/secondary configuration paths imported the helper by value.  Keep
    # those aliases synchronized so every variable with a known domain behaves alike.
    try:
