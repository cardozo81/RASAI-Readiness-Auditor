...
_M6_DEFINITIONS = (
    ...
    RuleDefinition("BR-GEO-021", "Indexable client-side routes must resolve through direct URL access", "JAVASCRIPT_RENDERING", "DISCOVERY_ACCESS", RuleScope.SNAPSHOT, dependencies=("BR-GEO-005", "BR-GEO-009"), severity=Severity.HIGH, basis="STANDARD", scoring_group="SPA_ROUTE"),
    RuleDefinition("BR-GEO-022", "Important internal navigation must expose crawlable destinations", "JAVASCRIPT_RENDERING", "DISCOVERY_ACCESS", RuleScope.SNAPSHOT, dependencies=("BR-GEO-009",), severity=Severity.MEDIUM, basis="STANDARD", scoring_group="SPA_NAVIGATION"),
