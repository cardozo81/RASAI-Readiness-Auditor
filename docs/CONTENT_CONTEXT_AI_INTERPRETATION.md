...
A saída transitória é retirada da resposta antes da normalização semântica tradicional e mantida somente em memória para a projeção final do HTML. A versão legível aparece separadamente em `sari.html`.
