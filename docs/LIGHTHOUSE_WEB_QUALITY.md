...
**Página principal:** `report-catalog/cat-04.html`.
...
**Página analítica detalhada:** `report-catalog/cat-02.html`.

**Resumo também visível:** `report-catalog/cat-04.html`, para que o conjunto das categorias Lighthouse seja reconhecível e comparável no mesmo contexto URL/dispositivo.
...
Quando o artifact contém `auditRefs` e `audits`, `cat-04.html` pode detalhar checks reprovados exatamente como evidência Lighthouse, sem promovê-los a finding proprietário do RASAi.
...
`report-catalog/cat-04.html` deve deixar explícito, no mesmo contexto URL/dispositivo:
...
`report-catalog/index.html` pode resumir a média descritiva dos contextos válidos para cada categoria disponível. Essa média não deve ser renomeada como “score do site” nem usada para produzir score composto. Agentic Browsing deve continuar explicitamente marcado como experimental.

`report-catalog/methodology.html` deve incluir as referências metodológicas aplicáveis a Performance, Accessibility, Best Practices, SEO, Agentic Browsing, PageSpeed, CrUX e Core Web Vitals.
