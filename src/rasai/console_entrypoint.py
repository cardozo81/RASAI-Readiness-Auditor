...
def main() -> int:
    ...
    # Financial authorization must run outside the catalog execution projection so the
    # operator can choose C/N or adjust AI before the per-AUD execution snapshot is frozen.
