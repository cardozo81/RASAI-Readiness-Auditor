...
def configure_ai_from_shortcut(state: Any, console: Any) -> None:
    """Open the canonical AI/provider configuration flow from another console screen."""
    _configure_ai(state, console)
