...
<footer class='footer'>Web Performance é evidência complementar. O Índice de Prontidão Search & IA e o Método de Pontuação de Prontidão permanecem metodologicamente independentes. IDs técnicos: SARI-001 e {SCORING_VERSION}.</footer></main></body></html>
"""
