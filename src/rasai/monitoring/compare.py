...
from .models import AuditSnapshot, ChangeEvent, ComparisonResult, GatePolicy, GateResult, Signal
...
def compare_audits(
    ...
    *,
    ...
    baseline = baseline_snapshot or read_audit_snapshot(baseline_workspace)
    current = current_snapshot or read_audit_snapshot(current_workspace)
    notes: list[str] = []
    comparable = True
