# 18 - Orquestração do tempo de execução de IA

**Estado:** vigente para o ambiente multiprovedor de IA em tempo de execução.
...
A apresentação canônica dessa telemetria é `report-catalog/ai-integrations.html`.
