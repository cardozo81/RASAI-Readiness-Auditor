...
def _apdex_specs() -> tuple[EnvironmentSpec, ...]:
    return (
        ...
        EnvironmentSpec(UX_SATISFIED_ENV, "Synthetic Apdex", "Threshold Satisfied/Tolerating do Experience Apdex.", "número > 0", required_when="Calibração manual sem Dynatrace.", notes="Sem default universal seguro; alinhe à KPM/SLO ou importe configuração Dynatrace."),
        EnvironmentSpec(UX_FRUSTRATED_ENV, "Synthetic Apdex", "Threshold Frustrated independente de 4T.", "número > 0", required_when="Calibração manual sem Dynatrace.", notes="Sem default universal seguro; alinhe à KPM/SLO ou importe configuração Dynatrace."),
