...
cd /d "%~dp0"
title RASAi - Console interativo
...
if errorlevel 1 (
    ...
    echo Instale CPython 3.13 e execute abrir-rasai-console.cmd novamente.
    exit /b 1
)
...
echo Renomeie ou remova ".venv" e execute abrir-rasai-console.cmd novamente.
goto :fail_pause

:python_not_found_after_install
echo.
echo [ERRO] Python 3.13 foi solicitado ao WinGet, mas nao ficou acessivel nesta sessao.
echo Feche esta janela e execute abrir-rasai-console.cmd novamente.
goto :fail_pause
