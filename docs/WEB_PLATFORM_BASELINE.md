...
Na auditoria, a projeção HTML canônica fica em `report-catalog/cat-01.html`, com métricas transversais também disponíveis em `report-catalog/metrics.html`. O relatório deve deixar separados:
