...
<section class='panel notice'><h2>Contrato metodológico</h2><p><strong>Estes dados não entram automaticamente em SARI-001/SCORE-GEO-003.</strong> A presença de um outcome externo não prova causalidade. URL Inspection descreve a versão conhecida pelo índice e não substitui um teste live; Search Performance descreve outcomes observados; CrUX History é dado de campo agregado.</p></section>
