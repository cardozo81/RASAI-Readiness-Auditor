...
def _validate_extension(payload: Mapping[str, Any], normalized: dict[str, Any]) -> dict[str, Any]:
    ...
    if enabled:
        ...
        # ai_provider=none is a valid execution choice. CAT-08 still remains a
        # required fulfillment item and therefore prevents full diagnostic closure
        # until a later RPR completes its AI analysis.
