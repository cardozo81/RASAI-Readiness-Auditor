...
A arquitetura SaaS hospedada complementa PostgreSQL com agendador/fila durável, workers Linux/container, armazenamento de objetos, gestão de segredos e contexto autenticado de tenant.
...
## 12. Web/API e plano de execução
