...
Isso mantém estáveis relatórios, manifests, referências de ciclo de vida e chaves de armazenamento de objetos.
...
Deployments hospedados devem usar gestor de segredos ou serviço de credenciais criptografado, persistindo apenas referências/metadados necessários à autorização e rotação.
...
Armazenamento de objetos hospedado é o destino de payloads imutáveis de execução:
