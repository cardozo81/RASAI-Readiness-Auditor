                ...
                return {
                    "output_text": json.dumps({
                        "suggestions": [{
                            ...
                            "evidence_ids": ["EV-M20"],
                            "confidence": 0.9,
                            "current_degradation": "A explicação atual é menos direta do que o finding exige.",
                            "expected_benefit": "Uma formulação mais direta pode facilitar a compreensão do conteúdo observado.",
                ...
                return {
                    "output_text": json.dumps({
                        "suggestions": [{
                            ...
                            "evidence_ids": ["EV-M20"],
                            "confidence": 0.9,
                            "current_degradation": "O finding registra lacuna de clareza no conteúdo observado.",
                            "expected_benefit": "Uma explicação mais clara pode melhorar a compreensão do conteúdo observado.",
